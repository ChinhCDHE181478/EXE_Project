...
export default function AdminDashboardPage() {
    ...
    () => [
      {
        ...
        hint: error ? "Không tải được dữ liệu" : "Tổng số người dùng",
        icon: (
      ...
      },
      {
        ...
        hint: error ? "Không tải được dữ liệu" : "Tổng doanh thu",
        icon: (
          <svg viewBox="0 0 24 24" className="h-6 w-6" fill="currentColor">
      ...
      },
      {
        ...
        hint: error ? "Không tải được dữ liệu" : "Số user mới trong hôm nay",
        icon: (
          <svg viewBox="0 0 24 24" className="h-6 w-6" fill="currentColor">
  ...
  const quick = useMemo(
    () => [
      { href: "/admin/payments", title: "Thanh toán", desc: "Quản lý giao dịch" },
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        ...
        <div className="xl:col-span-2 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <div className="text-sm text-slate-500">
                Biểu đồ chi tiết nằm trong mục Báo cáo (ưu tiên hoàn thiện UI trước).
              </div>
            </div>
          ...
          <div className="mt-4 h-[240px] sm:h-[280px] rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center text-sm text-slate-500">
            Chỗ đặt biểu đồ
          </div>
        </div>
      ...
      {error && (
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-xs text-slate-500">
            Gợi ý: set{" "}
            <code className="px-1 rounded bg-slate-100">NEXT_PUBLIC_API_URL</code>{" "}
            ={" "}
