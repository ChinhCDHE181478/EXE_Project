...
export default function HotelResultsPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-4 font-sans">
      <div className="container mx-auto px-4">
          ...
          <div className="lg:hidden mb-4">
             <button onClick={() => setFiltersOpen(true)} className="w-full h-11 rounded-xl bg-white shadow-sm ring-1 ring-black/10 px-4 flex items-center justify-between">
                <div className="flex items-center gap-2 text-sm font-medium text-slate-800">
                    <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#0891b2]/10 text-[#0891b2]"><svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor"><path d="M3 5h18v2H3V5zm4 6h10v2H7v-2zm3 6h4v2h-4v-2z" /></svg></span> Bộ lọc
                </div>
             </button>
          </div>
          ...
          <div className="grid grid-cols-12 gap-4">
             <aside className="hidden lg:block col-span-3 lg:col-span-2">
                <div className="sticky top-20 h-[calc(100vh-6rem)] overflow-y-auto pr-2 custom-scrollbar">
                    <FilterSidebar value={filters} onChange={(patch) => updateAndSearch(patch)} />
                </div>
             </aside>
             <section className="col-span-12 lg:col-span-5 xl:col-span-6 2xl:col-span-5">
             ...
             <aside className="col-span-12 lg:col-span-5 xl:col-span-4 2xl:col-span-5 hidden lg:block h-[calc(100vh-8rem)] sticky top-24">
